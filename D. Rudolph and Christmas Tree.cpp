...
long db c,d,e,f,g,h,j,k,l,m,o,p,q,t,x,y,z;
db mn=8675435789,mx=-8675868757,md=1000000007,aa=0,bb=0,cc=0;
st r,s,u,v,w;
ll a[950002],b[950002],i,n;
...
int main()
{
    ...
    wl(t--)
    {
        ...
        cout<<fixed<<setprecision(9)<<cc<<endl;
    }
}
