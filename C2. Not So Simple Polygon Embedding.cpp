...
db c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,t,x,y,z;
ll mn=8675435789,mx=-8675868757,PI=2*acos(0.0),md=1000000007,aa=0,bb=0,cc=0;
st r,s,u,v,w;
...
int main()
{
    ...
    {
        cin>>n;
        x=(cos(3.14159265359/(4*n)))/sin(3.14159265359/(2*n));
        printf("%.9f\n",x);
    }
}
